...
CLOSED: [2015-10-28 Wed 13:12]
*** PROGRESS Get total number of available memory in the kernel
*** TODO Calculate the total number of 4k memory blocks
*** TODO Create a memory bit map as an array of integers
*** TODO Create a function for setting a bit in memory bit map
*** TODO Create a function for unsetting a bit in memory bit map
